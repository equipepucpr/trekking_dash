...
final List<Map<String, dynamic>> chartsConfig = [
  ...
  {
    "section": {
      "name": "Tinkerboard Hardware Usage",
      "color": const Color(0x402c4260)
    },
    "charts": [
      {
        "chart": {
          ...
          "size": [400, 300],
          "getData": (Map data) {
            return <List<Object>>[['Used', data['used']], ['Free', data['free']]];
          }
        },

        "data": {
          "query": "http://localhost:5000/ram_usage",
          "xType": DataType.string
        },
      },
      {
        "chart": {
          ...
          "size": [400, 300],
          "getData": (Map data) {
            return (data['temperature'].toInt());
          }
        },

        "data": {
          "query": "http://localhost:5000/pi_temp",
          "xType": DataType.integer
        },
      },
    ]
